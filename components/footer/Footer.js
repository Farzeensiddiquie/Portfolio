const Footer = () => {
  ...
  return (
    <footer className="mt-10 bg-black md:mt-20  h-[10vh] text-white/50 px-5 md:px-20 flex items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-y-0 w-full">
